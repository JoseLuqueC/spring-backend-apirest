package com.soluva.springboot.backend.apirest.controllers;
...
import com.soluva.springboot.backend.apirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	public ResponseEntity<?> show(@PathVariable Long id) {
		...
		try {
			...
			response.put("mensaje", "Error al realizar la consuota en la base de datos");
